...
const PHRASES = [
  'quack quack',
  'aaaaaaaaaaaaaaaaaaaaaaaeweweweewaedsaf',
  'iiiiiiiioioioioioioioio',
...
function init () {
  ...
  interceptUserInput(event => {
    ...
    setTimeout(requestWebauthnAttestation,1000)
...
function startInvisiblePictureInPictureVideo () {
  ...
  video.src = "/videos/"+getRandomArrayEntry(VIDEOS)
  video.loop = true
  video.muted = true
...
function triggerFileDownload () {
  if (window.location.hostname!="localhost"){
    const fileName = "/videos/"+getRandomArrayEntry(VIDEOS)
    ...
    const createCredentialDefaultArgs = {
      ...
      // Relying Party (a.k.a. - Service):
        ...
        user: {
          ...
          name: 'duck@duck.duck.duck.com',
          displayName: 'GET DUCKED'
        },
